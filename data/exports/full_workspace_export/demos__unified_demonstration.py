...
try:
    ...
    from topology_algebra import CircleGroup, WindingNumber
    from conservation_algebra import ConservationAlgebra
    from fixedpoint_algebra import TrinityFixedPoints, QuaternionFixedPoints
except ImportError as e:
    print(f"Import error: {e}")
    print("Make sure all algebra modules are in the same directory")
    sys.exit(1)
